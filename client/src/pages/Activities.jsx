...
//   // Buggy code console log
//   // console.log("[Chapter-10][BUG] DOM rows rendered:", activities.length);
...
export default function Activities() {
  ...
  useEffect(() => {
    fetchActivities(1, 10000).then(res => {
      setActivities(res.data);
    });
  }, []);
...
//   console.log(
//     "[Chapter-10][FIXED] DOM rows rendered:",
